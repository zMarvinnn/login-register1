...
<div>
  ...
  <div class="Title1">
    <div class="box">
      <b>Texas Chainsaw Massacre</b>
    </div>
  </div>


    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=6VMQHf1tnhs" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>After nearly 50 years of hiding, Leatherface returns to terrorize a group of idealistic young friends who accidentally disrupt his carefully shielded world in a remote Texas town.</p>
      </div>

      <div class="card">
        <p><b>Released:</b> 2022-02-18</p>
        <p><b>Genre:</b> Horror</p>
        <p><b>Casts:</b>  Elsie Fisher, Moe Dunford, Sarah Yarkin, Nell Hudson, Jacob Latimore</p>
        <p><b>Duration:</b> 81 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Bad Hombre Films, Exurbia Films, Legendary Entertainment</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/56y9nmrp" target="_blank">http://tinyurl.com/56y9nmrp</a></p>
        <p><a href="http://tinyurl.com/3hbyt4tk" target="_blank">http://tinyurl.com/3hbyt4tk</a></p>
      </div>
