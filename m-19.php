...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="m-13.php" class="s1">
      <img src="images/actions/a-l/l6.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>A black ops assassin is forced to fight for her own survival after a job goes dangerously wrong.</p>
      </div>

      <div class="card">
        <p><b>Released:</b> 2020-08-06</p>
        <p><b>Genre:</b> Crime, Drama, Action, Mystery, Thriller</p>
        <p><b>Casts:</b> Diana Silvers, Jessica Chastain, Falk Hentschel, John Malkovich, Colin Farrell</p>
        <p><b>Duration:</b> 96 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> United States of America</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/32hts7s7" target="_blank">http://tinyurl.com/32hts7s7</a></p>
      </div>
