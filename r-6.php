...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/Romance/a-l/l6.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    ...
    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=cwdliqOGTLw" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>A New Yorker moves to Los Angeles in order to figure out his life while he housesits for his brother, and he soon sparks with his brother's assistant.</p>
      </div>

      <div class="card">
        <p><b>Released:</b>  2010-03-26</p>
        <p><b>Genre:</b> Comedy, Drama, Romance</p>
        <p><b>Casts:</b> Ben Stiller, Greta Gerwig, Rhys Ifans, Jennifer Jason Leigh, Merritt Wever</p>
        <p><b>Duration:</b> 107 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Scott Rudin Productions, Twins Financing</p>
      ...
      <div class="card">
        ...
        <p><a href="http://tinyurl.com/56r3jaay" target="_blank">http://tinyurl.com/56r3jaay</a></p>
      </div>
