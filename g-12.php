...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/adventure/a-l/l12.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    <div class="box">
      <b>Jurassic World Fallen Kingdom</b>
    </div>
  </div>


    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=vn9mMeWcgoM" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>Three years after the demise of Jurassic World, a volcanic eruption threatens the remaining dinosaurs on the isla Nublar, so Claire Dearing, the former park manager, recruits Owen Grady to help prevent the extinction of the dinosaurs once again.</p>
      </div>

      <div class="card">
        <p><b>Released:</b> 2018-06-06</p>
        <p><b>Genre:</b> Action, Adventure, Science Fiction</p>
        <p><b>Casts:</b> Peter Jason, Chris Pratt, Toby Jones, Michael Papajohn, Neil Bishop</p>
        <p><b>Duration:</b> 129 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Amblin Entertainment, Legendary Entertainment, Universal Pictures, Perfect World Pictures</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/32a7zkty" target="_blank">http://tinyurl.com/32a7zkty</a></p>
        <p><a href="http://tinyurl.com/42n28raz" target="_blank">http://tinyurl.com/42n28raz</a></p>
      </div>
