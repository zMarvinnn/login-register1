...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/adventure/a-l/l20.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    <div class="box">
      <b>Transformer Dark of the moon</b>
    </div>
  </div>


    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=Rf3OcxIFbRE" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>Sam Witwicky takes his first tenuous steps into adulthood while remaining a reluctant human ally of Autobot-leader Optimus Prime. The film centers around the space race between the USSR and the USA, suggesting there was a hidden Transformers role in it all that remains one of the planet's most dangerous secrets.</p>
      </div>

      <div class="card">
        <p><b>Released:</b> 2011-06-28</p>
        <p><b>Genre:</b> Action, Science Fiction, Adventure</p>
        <p><b>Casts:</b> Shia LaBeouf, John Malkovich, Ken Jeong, Frances McDormand, Josh Duhamel</p>
        <p><b>Duration:</b> 154 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Hasbro Studios, Paramount, Di Bonaventura Pictures, Indochina Productions</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/bdzcetmr" target="_blank">http://tinyurl.com/bdzcetmr</a></p>
        <p><a href="http://tinyurl.com/4zdx4eem" target="_blank">http://tinyurl.com/4zdx4eem</a></p>
      </div>
