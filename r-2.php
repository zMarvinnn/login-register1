...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/Romance/a-l/l2.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    <div class="box">
      <b>Alex Strange Love</b>
    </div>
  </div>


    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=V-1KhZiQs3U" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      ...
      <div class="card">
        <p><b>Released:</b>  2018-04-16</p>
        <p><b>Genre:</b> Comedy, Drama</p>
        <p><b>Casts:</b> Daniel Doheny, Madeline Weinstein, Antonio Marziale, Daniel Zolghadri, Nik Dodani</p>
        <p><b>Duration:</b> 99 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Mighty Engine, STX Entertainment, Red Hour</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/2xh6bhph" target="_blank">http://tinyurl.com/2xh6bhph</a></p>
        <p><a href="http://tinyurl.com/57ekmj7t" target="_blank">http://tinyurl.com/57ekmj7t</a></p>
      </div>
