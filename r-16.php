...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/Romance/a-l/l16.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    <div class="box">
      <b>Our souls at Night</b>
    </div>
  </div>


    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=lci71HjGvaM" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>Addie Moore and Louis Waters, a widow and widower, have lived next to each other for years. The pair have almost no relationship, but that all changes when Addie tries to make a connection with her neighbour.</p>
      </div>

      <div class="card">
        <p><b>Released:</b>  2017-09-01</p>
        <p><b>Genre:</b> Romance, Drama</p>
        <p><b>Casts:</b> Robert Redford, Jane Fonda, Matthias Schoenaerts, Judy Greer, Bruce Dern</p>
      ...
      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/mtpefed7" target="_blank">http://tinyurl.com/mtpefed7</a></p>
        <p><a href="http://tinyurl.com/57x9nuhk" target="_blank">http://tinyurl.com/57x9nuhk</a></p>
      </div>
