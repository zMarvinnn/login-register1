...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/adventure/a-l/l2.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    <div class="box">
      <b>BATTLE_ LOS ANGELES</b>
    </div>
  </div>


    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=Yt7ofokzn04" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>In February 1942 Us forces engaged an unidentified flying object above Los Angeles. Now almost 70 years later, the alien invaders have returned.</p>
      </div>

      <div class="card">
        <p><b>Released:</b> 2011-03-10</p>
        <p><b>Genre:</b> Science Fiction, Thriller, Adventure</p>
        <p><b>Casts:</b>  Kel Mitchell, Nia Peeples, Dylan Vox, Gerald Webb, Theresa June-Tao</p>
        <p><b>Duration:</b> 91 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> The Asylum</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/3ru54ped" target="_blank">http://tinyurl.com/3ru54ped</a></p>
        <p><a href="http://tinyurl.com/4h3xzjz7" target="_blank">http://tinyurl.com/4h3xzjz7</a></p>
      </div>
