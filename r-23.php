...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/Romance/a-l/l23.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    <div class="box">
      <b>To All the Boys Ive Loved Before</b>
    </div>
  </div>


    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=555oiY9RWM4" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>Lara Jean's love life goes from imaginary to out of control when her secret letters to every boy she's ever fallen for are mysteriously mailed out.</p>
      </div>

      <div class="card">
        <p><b>Released:</b>  2018-08-16</p>
        <p><b>Genre:</b> Comedy, Romance</p>
        <p><b>Casts:</b> Isabelle Beech, Christian Michael Cooper, Noah Centineo, Madeleine Arthur, Janel Parrish</p>
        <p><b>Duration:</b> 100 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Awesomeness Films, Overbrook Entertainment</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/5ev65zbb" target="_blank">http://tinyurl.com/5ev65zbb</a></p>
        <p><a href="http://tinyurl.com/bakhym99" target="_blank">http://tinyurl.com/bakhym99</a></p>
      </div>
