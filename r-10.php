...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/Romance/a-l/l10.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    ...
    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=jY0Yzb7aaVo" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>When a huge blizzard (that doesn't show signs of stopping) hits, Gracetown is completely snowed in. But even though it's cold outside, things are heating up inside, proving that Christmas is magical when it comes to love.</p>
      </div>

      <div class="card">
        <p><b>Released:</b>  2019-11-08</p>
        <p><b>Genre:</b> Romance, Comedy</p>
        <p><b>Casts:</b> Liv Hewson, Jon Champagne, Isabela Moner, Matthew Noszka, Victor Rivers</p>
        <p><b>Duration:</b> 93 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Dylan Clark Productions</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/3s3ka644" target="_blank">http://tinyurl.com/3s3ka644</a></p>
        <p><a href="http://tinyurl.com/mrxnf8jd" target="_blank">http://tinyurl.com/mrxnf8jd</a></p>
      </div>
