...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/adventure/a-l/l23.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    ...
    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=AiohkY_XQYQ" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>Deep inside the mountain of Dovre, something gigantic awakens after being trapped for a thousand years. Destroying everything in its path, the creature is fast approaching the capital of Norway. But how do you stop something you thought only existed in Norwegian folklore?</p>
      </div>

      <div class="card">
        <p><b>Released:</b>  2022-12-01</p>
        <p><b>Genre:</b> Action, Adventure, Fantasy</p>
        <p><b>Casts:</b> Kim S. Falck-Jørgensen, Pål Anders Nordvi, Mads Sjøgård Pettersen, Ine Marie Wilmann, Hugo Mikal Skår</p>
        <p><b>Duration:</b> 120 min</p>
        <p><b>Country:</b> Norway</p>
        <p><b>Production:</b> Motion Blur</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/42hxjvmf" target="_blank">http://tinyurl.com/42hxjvmf</a></p>
        <p><a href="http://tinyurl.com/3mkfrx32" target="_blank">http://tinyurl.com/3mkfrx32</a></p>
      </div>
