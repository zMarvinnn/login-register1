...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/Romance/a-l/l25.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    <div class="box">
      <b>Your Place or Mine</b>
    </div>
  </div>


    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=5JyfgkPMXk0" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      ...
      <div class="card">
        <p><b>Released:</b>  2023-02-10</p>
        <p><b>Genre:</b> Comedy, Romance</p>
        <p><b>Casts:</b> Reese Witherspoon, Ashton Kutcher, Jesse Williams, Zoe Chao, Steve Zahn</p>
        <p><b>Duration:</b> 109 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Aggregate Films, Hello Sunshine, Lean Machine</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/mprvba3r" target="_blank">http://tinyurl.com/mprvba3r</a></p>
        <p><a href="http://tinyurl.com/mr3y5dx6" target="_blank">http://tinyurl.com/mr3y5dx6</a></p>
      </div>
