...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/adventure/a-l/l11.jpeg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    ...
    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=ZoCyL_Pqzu8" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>In a universe where human genetic material is the most precious commodity, an impoverished young Earth woman becomes the key to strategic maneuvers and internal strife within a powerful dynasty</p>
      </div>

      <div class="card">
        <p><b>Released:</b> 2015-02-04</p>
        <p><b>Genre:</b> Science Fiction, Fantasy, Action, Adventure</p>
        <p><b>Casts:</b> Mila Kunis, Channing Tatum, Sean Bean, Eddie Redmayne, Douglas Booth</p>
        <p><b>Duration:</b> 123 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Anarchos Productions, Village Roadshow Pictures, Dune Entertainment, Warner Bros. Pictures</p>
      ...
      <div class="card">
        ...
        <p><a href="http://tinyurl.com/vp2drhb9" target="_blank">http://tinyurl.com/vp2drhb9</a></p>
      </div>
