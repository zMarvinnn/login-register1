...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/adventure/a-l/l5.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    ...
    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=ksj69JaBrAo" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>Dora, a girl who has spent most of her life exploring the jungle with her parents, now must navigate her most dangerous adventure yet: high school. Always the explorer, Dora quickly finds herself leading Boots (her best friend, a monkey), Diego, and a rag tag group of teens on an adventure to save her parents and solve the impossible mystery behind a lost Inca civilization.</p>
      </div>

      <div class="card">
        <p><b>Released:</b> 2019-08-08</p>
        <p><b>Genre:</b> Adventure, Comedy, Family</p>
        <p><b>Casts:</b> Isabela Moner, Jeffrey Wahlberg, Benicio del Toro, Eugenio Derbez, Temuera Morrison</p>
        <p><b>Duration:</b> 100 min</p>
        <p><b>Country:</b> Austria, United States of America</p>
        <p><b>Production:</b>  Nickelodeon Movies, Paramount, Paramount Players, Screen Queensland, Walden Media</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/4ehxjh2z" target="_blank">http://tinyurl.com/4ehxjh2z</a></p>
        <p><a href="http://tinyurl.com/yckx68dh" target="_blank">http://tinyurl.com/yckx68dh</a></p>
      </div>
