...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/adventure/a-l/l3.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    ...
    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=8NNQqHsIc-4" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>When mankind beams a radio signal into space, a reply comes from Planet G, in the form of several alien crafts that splash down in the waters off Hawaii. Lieutenant Alex Hopper is a weapons officer assigned to the USS John Paul Jones, part of an international naval coalition which becomes the world's last hope for survival as they engage the hostile alien force of unimaginable strength. While taking on the invaders, Hopper must also try to live up to the potential that his brother, and his fiancée's father, Admiral Shane, expect of him.</p>
      </div>

      <div class="card">
        <p><b>Released:</b> 2012-04-11</p>
        <p><b>Genre:</b> Thriller, Action, Adventure, Science Fiction</p>
        <p><b>Casts:</b>  Liam Neeson, Taylor Kitsch, Alexander Skarsgård, Rihanna, Tadanobu Asano</p>
        <p><b>Duration:</b> 131 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Universal Pictures, Hasbro, Bluegrass Films, Film 44</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/35vc6v2m" target="_blank">http://tinyurl.com/35vc6v2m</a></p>
        <p><a href="http://tinyurl.com/5n7pmtun" target="_blank">http://tinyurl.com/5n7pmtun</a></p>
      </div>
