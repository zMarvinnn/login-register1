...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/Romance/a-l/l5.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    ...
    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=z_-_hIuE1YA" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>After years of putting her career ahead of love, stand-up comic Andrea Singer has stumbled upon the perfect guy. On paper, he checks all the boxes but is he everything he appears to be?</p>
      </div>

      <div class="card">
        <p><b>Released:</b>  2021-06-23</p>
        <p><b>Genre:</b> Comedy, Romance</p>
        <p><b>Casts:</b> Iliza Shlesinger, Matt McGorry, Britney Young, Taylor Marie Hill, Rebecca Rittenhouse</p>
        <p><b>Duration:</b> 92 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Burn Later Productions, Meridian Content, Universal Pictures</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/2f84rnse" target="_blank">http://tinyurl.com/2f84rnse</a></p>
        <p><a href="http://tinyurl.com/3ekd7rnn" target="_blank">http://tinyurl.com/3ekd7rnn</a></p>
      </div>
