...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/Romance/a-l/l19.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    ...
    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=X-eRc9PF3TU" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      <div class="card">
        ...
        <p>Two young assistants in New York City realize they can make their lives easier by setting up their workaholic bosses to date. While trying to perpetuate this romantic ruse between their nightmare bosses, the assistants realize they themselves might actually be right for each other.</p>
      </div>

      <div class="card">
        <p><b>Released:</b>  2018-06-15</p>
        ...
        <p><b>Production:</b> Treehouse Pictures</p>

      </div>

      <div class="card">
        <h1><b>Links</b></h1>
        <p><a href="http://tinyurl.com/bdvpprky" target="_blank">http://tinyurl.com/bdvpprky</a></p>
        <p><a href="http://tinyurl.com/5n88hrbb" target="_blank">http://tinyurl.com/5n88hrbb</a></p>
      </div>
