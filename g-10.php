...
<div>
  ...
  <section id="main-movie">
    ...
    <a href="#" class="s1">
      <img src="images/adventure/a-l/l10.jpg"/>
    </a>
    </div>
  </section>
  ...
  <div class="Title1">
    ...
    <div class="Trailer">
      <a href="https://www.youtube.com/watch?v=f_HvoipFcA8" target="_blank">
      <button>
  ...
  <div class="label">
    <div class="flex">
      ...
      <div class="card">
        <p><b>Released:</b> 2021-07-28</p>
        <p><b>Genre:</b> Adventure, Family, Fantasy, Comedy</p>
        <p><b>Casts:</b>  John Flanagan, Dani Rovira, Jesse Plemons, Emily Blunt, Dwayne Johnson</p>
        <p><b>Duration:</b> 118 min</p>
        <p><b>Country:</b> United States of America</p>
        <p><b>Production:</b> Flynn Picture Company, Walt Disney Pictures, TSG Entertainment, Seven Bucks Productions, Davis Entertainment, Zaftig Films</p>
      ...
      <div class="card">
        ...
        <p><a href="http://tinyurl.com/yrr984ek" target="_blank">http://tinyurl.com/yrr984ek</a></p>
      </div>
